 ...
 */
package zayneb.views;


import com.esprit.entity.medecin;
...
import com.esprit.service.medecinservice;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        actualiser.setOnAction(event->{
            try {
                ...
                Parent pagePieChart=FXMLLoader.load(getClass().getResource("/zayneb/views/affichermedecin.fxml"));
        ...
        try {
            Parent page   = FXMLLoader.load(getClass().getResource("/zayneb/views/ajouterRDV.fxml"));
            Scene scene = new Scene(page );
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
